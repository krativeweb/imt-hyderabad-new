  ...
  <div class="container shadow-sm">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      <ul class="navbar-nav align-items-lg-center">
        <li class="nav-item"><a class="nav-link" href="placements.php">HOME</a></li>
        <li class="nav-item"><a class="nav-link" href="campus-recruitment.php">CAMPUS PLACEMENTS</a></li>
        <li class="nav-item"><a class="nav-link" href="internship.php">SUMMER INTERNSHIPS</a></li>
        <li class="nav-item"><a class="nav-link" href="corporate-connect.php">CORPORATE CONNECT</a></li>
